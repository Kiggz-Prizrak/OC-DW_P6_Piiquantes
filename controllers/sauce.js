    ...
    if (userHasDisliked === true) {
        switch (demande) {
            case 1: {
                ...
                const usersDislikedUpdates = sauce.usersLiked.filter(element => element !== req.body.userId )
            ...
            case 0 :{ 
                ...
                const usersDislikedUpdates = sauce.usersDisliked.filter(element => element !== req.body.userId )
                sauce.usersDisliked = usersDislikedUpdates
                sauce.dislikes = sauce.usersDisliked.length
                await sauce.save()
